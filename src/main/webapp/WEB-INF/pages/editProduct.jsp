                ...
                <div class="col-md-8 col-lg-6 col-xl-4 ">
                    <form class="needs-validation" novalidate method="POST"
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="product_id" name="product_id" value="${product.idProduct}"
                                   class="form-control form-control-lg"/>
                        </div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="product_name">Product name</label>
                            <input type="text" id="product_name" name="product_name" value="${product.productName}"
                                   class="form-control form-control-lg"/>
                        </div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="product_quantity">Quantity</label>
                            <input type="number" id="product_quantity" name="product_quantity" value="${product.quantity}"
                                   class="form-control form-control-lg"/>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="product_provider" name="product_provider" value="${product.provider}"
                                   class="form-control form-control-lg"/>
